...
`;
export const StyledExplainerBtn = styled(motion.button)`
  position: fixed;
  right: 32px;
  top: 8px;
  font-size: 48px;
...
export const StyledExplainer = styled.div`
  position: fixed;
  top: 0;
  ...
  color: white;
  z-index: 1000;
  transition: right 0.2s ease-in-out; // Smooth transition for sliding effect
  padding: 20px;
  overflow-y: auto;
  scrollbar-width: thin;
